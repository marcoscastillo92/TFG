...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function vl(){return new Yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qo(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function yl(){return new Yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qo(),fragmentShader:`
...
`].filter(Bi).join(`
`)),o=Po(o),o=Cl(o,t),o=Ll(o,t),a=Po(a),a=Cl(a,t),a=Ll(a,t),o=Pl(o),a=Pl(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
